...
//TODO As in the Java version, Experiment has no 'Excite Atom' button. The only way to get out of the metastable state is to change the light source to white.
/**
