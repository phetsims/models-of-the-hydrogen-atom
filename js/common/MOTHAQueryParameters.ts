...
const SCHEMA_MAP: Record<string, QueryStringMachineSchema> = {
  ...
  // Size of the uniform 3D grid used to compute probability density for Schrodinger orbitals. Because orbitals have
  // reflectional symmetry about the origin, we only need to sample probability density in 1 octant of the 3D space,
